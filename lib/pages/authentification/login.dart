import 'package:ambulanceHailerDriver/pages/authentification/signup.dart';
import 'package:ambulanceHailerDriver/pages/dashboard/dashboard_page.dart';
import 'package:ambulanceHailerDriver/pages/home/home_page.dart';
import 'package:ambulanceHailerDriver/utils/CustomColors.dart';
import 'package:ambulanceHailerDriver/utils/CustomTextStyle.dart';
...
class _LoginState extends State<Login> {
  ...
  AuthentificationController authentificationController = Get.put(AuthentificationController());
  ...
  void loginAndAuthentificationUser() async{
    UserCredential loginResult = (await
      _firebaseAuth.signInWithEmailAndPassword
        (email: authentificationController.emailController.text,
          password: authentificationController.passwordController.text).catchError((onError){
